...
SAVE_DIR = "subset_output"
if not os.path.exists(SAVE_DIR):
    os.makedirs(SAVE_DIR)

print("# Loading subset of PCam dataset...")
dataset_path = '/home/songshan/Documents/data/pcam'
...
x_train = np.array(HDF5Matrix(train_x_path, 'x', start=0, end=1000))
y_train = np.array(HDF5Matrix(train_y_path, 'y', start=0, end=1000))
x_val = np.array(HDF5Matrix(val_x_path, 'x', start=0, end=100))
y_val = np.array(HDF5Matrix(val_y_path, 'y', start=0, end=100))
x_test = np.array(HDF5Matrix(test_x_path, 'x', start=0, end=100))
y_test = np.array(HDF5Matrix(test_y_path, 'y', start=0, end=100))
...
batch_size = 32
epochs = 10
h5_path = os.path.join(SAVE_DIR,"model_subset.h5")
